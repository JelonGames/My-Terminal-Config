...
alias ompconfig="vim ~/.profile.omp.yaml"
...
# evals
eval "$(oh-my-posh init zsh --config 'https://raw.githubusercontent.com/JelonGames/My-Terminal-Config/refs/heads/main/.profile.omp.yaml')"
